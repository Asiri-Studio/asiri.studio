...
}).add(textAnimation("h1.animText .letter"), "-=400").add({
    targets: "#hero .button",
    scale: [
        0.8,
        1
...
var clientsAnimationTimeline = anime.timeline({
    loop: false,
    autoplay: false
}).add(textAnimation(".clients .animText .letter")).add({
...
function setupPortfolioItemAnimations() {
    ...
    portfolioItems.forEach((el, index)=>{
        ...
        portfolioItemAnimations[index] = anime.timeline({
            loop: false,
            autoplay: false
        }).add(textAnimation(letters)).add({
            targets: buttonSVG,
            scale: [
                1.4,
                1
...
var reasoningAnimationTimeline = anime.timeline({
    loop: false,
    autoplay: false
...
var cardAnimationTimeline = anime.timeline({
    autoplay: false,
    loop: false
}).add({
    targets: ".card",
