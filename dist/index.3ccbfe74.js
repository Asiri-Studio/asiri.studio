var ScrollOut = function() {
    ...
    function v(e, t) {
        return e && 0 !== e.length ? e.nodeName ? [
            e
        ] : [].slice.call(e[0].nodeName ? e : (t || document.documentElement).querySelectorAll(e)) : [];
    }
    function h(e, t) {
    ...
    return function(L) {
        ...
        function n() {
            ...
            for(var l, c = !1, s = 0; s < y.length; s++){
                ...
                var h = u.clientHeight || u.offsetHeight || 0, m = u.clientWidth || u.offsetWidth || 0, g = (S(d + m, P, P + e) - S(d, P, P + e)) / m, p = (S(v + h, _, _ + t) - S(v, _, _ + t)) / h, w = 1 === g ? 0 : T(d - P), X = 1 === p ? 0 : T(v - _), Y = S((P - (m / 2 + d - e / 2)) / (e / 2), -1, 1), b = S((_ - (h / 2 + v - t / 2)) / (t / 2), -1, 1), D = void 0;
...
//# sourceMappingURL=index.3ccbfe74.js.map
