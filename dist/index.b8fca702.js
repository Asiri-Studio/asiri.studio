...
var _preloader = require("./animations/preloader");
var _carousel = require("./animations/carousel");
var _text = require("./animations/text");
var _logo = require("./animations/logo");
...
(0, _preloader.heroPreloaderTimeline).add((0, _helpers.textAnimation)("h1.animText .letter"), "-=400").add({
    ...
    easing: "easeOutCirc",
    delay: (0, _animejsDefault.default).stagger(48)
}, "-=1200").add({
...
(0, _preloader.heroPreloaderTimeline).play();
// CLIENTS SECTION TIMELINE
var clientsAnimationTimeline = (0, _animejsDefault.default).timeline({
    loop: false,
    autoplay: false
}).add((0, _helpers.textAnimation)(".clients .animText .letter")).add({
...
},{}],"lIiRG":[function(require,module,exports) {
"use strict";
...
/** find elements */ function $(e, parent) {
...
function setAttrs(el, attrs) {
    ...
    for(var key in attrs)if (key.indexOf("_")) el.setAttribute("data-" + hyphenate(key), attrs[key]);
}
function setProps(cssProps) {
    return function(el, props) {
        for(var key in props)if (key.indexOf("_") && (cssProps === true || cssProps[key])) el.style.setProperty("--" + hyphenate(key), round(props[key]));
    };
}
var clearTask;
var subscribers = [];
...
function enqueue() {
    if (!clearTask && subscribers.length) clearTask = requestAnimationFrame(loop);
}
...
function main(opts) {
    ...
    function update() {
        ...
        for(var index_1 = 0; index_1 < elementContextList.length; index_1++){
            ...
            var visible = void 0;
            if (opts.offset) visible = unwrap(opts.offset, element, ctx, doc) <= clientOffsety ? 1 : 0;
            else if ((unwrap(opts.threshold, element, ctx, doc) || 0) < visibleX * visibleY) visible = 1;
            else visible = 0;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "textAnimation", ()=>textAnimation);
parcelHelpers.export(exports, "stampRevealAnimation", ()=>stampRevealAnimation);
parcelHelpers.export(exports, "stampRotateAnimation", ()=>stampRotateAnimation);
parcelHelpers.export(exports, "cardAnimationTimeline", ()=>cardAnimationTimeline);
var _animejs = require("animejs");
var _animejsDefault = parcelHelpers.interopDefault(_animejs);
const textAnimation = (el)=>({
        ...
        easing: "easeOutCirc",
        delay: (0, _animejsDefault.default).stagger(4.8)
    });
const stampRevealAnimation = (el, rotate)=>(0, _animejsDefault.default)({
        targets: el,
        duration: 1200,
        elasticity: 600,
        opacity: [
...
const stampRotateAnimation = (el)=>(0, _animejsDefault.default)({
        targets: el,
        rotate: [
            0,
            360
...
const cardAnimationTimeline = (cards)=>(0, _animejsDefault.default).timeline({
        autoplay: false,
        loop: false
    }).add({
        targets: cards,
        ...
        easing: "easeOutCirc",
        delay: (0, _animejsDefault.default).stagger(200)
    }).add(textAnimation(".card .animText .letter"), "-=1200").add({
        targets: ".card .icon",
        duration: 640,
        elasticity: 600,
        opacity: [
...
},{"animejs":"jokr5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"laI92":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "heroPreloaderTimeline", ()=>heroPreloaderTimeline);
parcelHelpers.export(exports, "preloaderTimeline", ()=>preloaderTimeline);
var _animejs = require("animejs");
var _animejsDefault = parcelHelpers.interopDefault(_animejs);
var heroLogo = document.querySelector("#hero .logoSVG").getBoundingClientRect();
const heroPreloaderTimeline = (0, _animejsDefault.default).timeline({
    loop: false,
    autoplay: false
}).add({
    ...
    easing: "easeOutCirc",
    delay: (0, _animejsDefault.default).stagger(36)
}, "+=500").add({
...
const preloaderTimeline = (0, _animejsDefault.default).timeline({
    loop: false,
    autoplay: false
}).add({
    targets: ".logoSVG .logoTEXT path",
...
},{"animejs":"jokr5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"boC3Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _animejs = require("animejs");
var _animejsDefault = parcelHelpers.interopDefault(_animejs);
...
function imageLoaded() {
    ...
    if (imagesLoaded >= totalImages * imageMultiplier) {
        ...
        carouselAnimation = (0, _animejsDefault.default)({
...
},{"animejs":"jokr5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l0bB7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _animejs = require("animejs");
var _animejsDefault = parcelHelpers.interopDefault(_animejs);
var _scrollOut = require("scroll-out");
...
textToAnimate.forEach((textWrapper)=>{
    textWrapper.innerHTML = textWrapper.innerHTML.split("<br>").reduce((result, str)=>result + `${str.replace(/\S/g, "<span class='letter'>$&</span>")} <br>`, "");
});
...
function setupIndependentTextAnimations() {
    ...
    independentTexts.forEach((el, index)=>{
        ...
        independentTextAnimations[index] = (0, _animejsDefault.default)((0, _helpers.textAnimation)(letters));
    });
}
...
(0, _scrollOutDefault.default)({
    ...
    onHidden: function(el, ctx) {
        if (independentTextAnimations[ctx.index]) independentTextAnimations[ctx.index].reset();
    }
});

},{"animejs":"jokr5","scroll-out":"lIiRG","../helpers":"luDvE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1e6mZ":[function(require,module,exports) {
...
logos.forEach((logo)=>{
    ...
    logo.addEventListener("mouseenter", ()=>logoMouseEnterAnimation(icon), false);
    logo.addEventListener("mouseleave", ()=>logoMouseLeaveAnimation(icon), false);
});

},{}],"hVBZu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _scrollOut = require("scroll-out");
var _scrollOutDefault = parcelHelpers.interopDefault(_scrollOut);
var _helpers = require("../helpers");
...
const setupStampAnimations = ()=>{
    ...
    stamps.forEach((el, index)=>{
        stampAnimations[index] = {
            rotate: (0, _helpers.stampRotateAnimation)(el)
        };
        stampAnimations[index].reveal = (0, _helpers.stampRevealAnimation)(el, stampAnimations[index].rotate);
    });
};
...
function setupPortfolioItemAnimations() {
    ...
    portfolioItems.forEach((el, index)=>{
        ...
        portfolioItemAnimations[index] = (0, _animejsDefault.default).timeline({
            loop: false,
            autoplay: false
...
(0, _scrollOutDefault.default)({
    ...
    onHidden: function(el, ctx) {
        if (portfolioItemAnimations[ctx.index]) portfolioItemAnimations[ctx.index].reset();
...
const setupCardAnimations = ()=>{
    ...
    cardLists.forEach((list, index)=>{
        ...
        cardAnimations[index] = (0, _helpers.cardAnimationTimeline)(cards);
    });
};
setupCardAnimations();
(0, _scrollOutDefault.default)({
